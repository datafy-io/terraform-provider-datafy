...
Existing autoscaling rules can be imported using a composite ID in the format `account_id:rule_id`:

```shell
terraform import datafy_autoscaling_rule.example 79c406c5-7b64-43f2-ba76-9b01e74e3d90:4b1c9d7e-2a8f-4e6b-bc23-5d8f7a9b3c12
```
