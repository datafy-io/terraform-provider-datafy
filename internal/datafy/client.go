...
func (c *Client) CreateAccountAutoscalingRule(ctx context.Context, req *CreateAccountAutoscalingRuleRequest) (*CreateAccountAutoscalingRuleResponse, error) {
	resp, err := c.callAPI(ctx, http.MethodPost, fmt.Sprintf("/api/v1/accounts/%s/autoscaling/rules", req.AccountId), nil, map[string]interface{}{
		"active": req.Active,
		"mode":   req.Mode,
		"rule":   req.Rule,
	})
...
func (c *Client) GetAccountAutoscalingRule(ctx context.Context, req *GetAccountAutoscalingRuleRequest) (*GetAccountAutoscalingRuleResponse, error) {
	resp, err := c.callAPI(ctx, http.MethodGet, fmt.Sprintf("/api/v1/accounts/%s/autoscaling/rules/%s", req.AccountId, req.RuleId), nil, nil)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func (c *Client) UpdateAccountAutoscalingRule(ctx context.Context, req *UpdateAccountAutoscalingRuleRequest) (*UpdateAccountAutoscalingRuleResponse, error) {
	resp, err := c.callAPI(ctx, http.MethodPut, fmt.Sprintf("/api/v1/accounts/%s/autoscaling/rules/%s", req.AccountId, req.RuleId), nil, map[string]interface{}{
		"active": req.Active,
		"mode":   req.Mode,
		"rule":   req.Rule,
	})
...
func (c *Client) DeleteAccountAutoscalingRule(ctx context.Context, req *DeleteAccountAutoscalingRuleRequest) (*DeleteAccountAutoscalingRuleResponse, error) {
	resp, err := c.callAPI(ctx, http.MethodDelete, fmt.Sprintf("/api/v1/accounts/%s/autoscaling/rules/%s", req.AccountId, req.RuleId), nil, nil)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
